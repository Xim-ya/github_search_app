...
part of 'repo_item_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

RepoItemResponse _$RepoItemResponseFromJson(Map<String, dynamic> json) =>
    RepoItemResponse(
      id: json['id'] as int,
      nodeId: json['node_id'] as String,
      name: json['name'] as String,
      fullName: json['full_name'] as String,
      owner: RepoOwnerResponse.fromJson(json['owner'] as Map<String, dynamic>),
...
Map<String, dynamic> _$RepoItemResponseToJson(RepoItemResponse instance) =>
    <String, dynamic>{
      'id': instance.id,
