...
part of 'pr_item_response.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PrItemResponse _$PrItemResponseFromJson(Map<String, dynamic> json) =>
    PrItemResponse(
      json['body'] as String?,
      json['url'] as String,
      ...
      PrFieldResponse.fromJson(json['pull_request'] as Map<String, dynamic>),
      json['draft'] as bool,
    );
