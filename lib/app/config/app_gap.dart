...
abstract class Gap {
  ...
  static const size3 = SizedBox(width: 3, height: 3);
  static const size4 = SizedBox(width: 4, height: 4);
  static const size5 = SizedBox(width: 4, height: 4);
  ...
  static const size13 = SizedBox(width: 13, height: 13);
  static const size14 = SizedBox(width: 14, height: 14);
  static const size15 = SizedBox(width: 15, height: 15);
  ...
  static const size31 = SizedBox(width: 31, height: 31);
